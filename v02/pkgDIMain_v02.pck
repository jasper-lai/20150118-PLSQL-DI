CREATE OR REPLACE PACKAGE pkgDIMain_v02 
IS
/*******************************************************************************
   NAME:       pkgDIMain_v02
...
END pkgDIMain_v02;
/
CREATE OR REPLACE PACKAGE BODY pkgDIMain_v02 
IS
...
*******************************************************************************/
   ...
   BEGIN
      ...
      lv_TradeTax := pkgDIPayment_v02.fcGetTradeTax(lv_TradeAmt);
      lv_CommFee  := pkgDIPayment_v02.fcGetCommeFee(pi_ChannelKind, lv_TradeAmt);
