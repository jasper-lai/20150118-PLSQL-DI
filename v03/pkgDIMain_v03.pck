CREATE OR REPLACE PACKAGE pkgDIMain_v03 
IS
/*******************************************************************************
   NAME:       pkgDIMain_v03
   PURPOSE:    Demo for DI with PL/SQL version 3.0
...
END pkgDIMain_v03;
/
CREATE OR REPLACE PACKAGE BODY pkgDIMain_v03 
IS
...
*******************************************************************************/
   ...
   BEGIN
      ...
      lv_TradeTax := pkgDIPayment_v03.fcGetTradeTax(lv_TradeAmt);
      lv_CommFee  := pkgDIPayment_v03.fcGetCommeFee(pi_ChannelKind, lv_TradeAmt);
